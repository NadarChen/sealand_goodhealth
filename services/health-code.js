...
exports.canSaveUserList = function(e) {
    ...
    return t({
        url: "/prominent-citizens/grid-operator/v1/relieve",
        method: "POST",
        data: e
    });
    ...
    return t({
        url: "/prominent-citizens/grid-manage/v1/operators/" + e,
        method: "GET"
    });
    ...
    return t({
        url: "/prominent-citizens/grid-monitor/v1/" + e,
        method: "GET"
    });
    ...
    return t({
        url: "/prominent-citizens/grid-operator/v1/" + e,
        method: "GET"
    });
}, exports.getGridMonitorList = function(e) {
    return t({
        url: "/prominent-citizens/grid-operator/v1/points/" + e,
        method: "GET"
    });
}, exports.getGridMonitorPoints = function(e) {
    return t({
        url: "/prominent-citizens/grid-monitor/v1/points/" + e,
        method: "GET"
    });
    ...
    return t({
        url: "/prominent-citizens/grid-manage/v1/" + e,
        method: "GET"
    });
...
}, exports.getPassQrcCode = function(e, r, n) {
    return t({
        url: "/prominent-citizens/grid-operator/v1/qrcCode?operatorId=" + e + "&pointId=" + r + "&passRole=" + n,
        method: "GET"
    });
    ...
    return t({
        url: "/prominent-citizens/grid-operator/v1/findInfoByKey?key=" + e,
        method: "GET"
    });
}, exports.relationUserSave = function(e) {
    return t({
        url: "/prominent-citizens/communityPassReg/v1/save",
        method: "POST",
        data: e
    });
...
}, exports.createCodeByKey = function(e, r, n) {
    return t({
        url: "/prominent-citizens/grid-operator/v1/createCodeByKey?key=" + e + "&page=" + r + "&qrCodeKey=" + n,
        method: "GET"
    });
}, exports.healthycardAuth = function(e) {
    return t({
        url: "/authentication/healthycard/v1/auth?confirm=" + e,
        method: "GET"
    });
}, exports.healthyAuthState = function() {
    return t({
        url: "/authentication/healthycard/v1/authState",
        method: "GET"
    });
}, exports.healthyRegister = function(e) {
    return t({
        url: r[r.env].electronCard + "/api/register",
        method: "POST",
        data: e
    });
};