...
Component({
    ...
    methods: {
        ...
        getRange: function(e) {
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, i = arguments[2], r = this.properties, o = r.type, a = r.value, s = t[o];
            if (n + 1 < parseInt(s)) {
                var u = this.getDataByParentCode(i, n + 1);
                e[n + 1] = u;
                var c = this.findItemByName(u, a[n + 1]), g = c && c.code || u[0].code;
        ...
        getRegionData: function() {
            var t = this;
            return n = !0, this._retry = 3, Promise.all([ this.$request("https://sgzy-1301196439.cos.ap-guangzhou.myqcloud.com/test-json/1.json"), this.$request("https://sgzy-1301196439.cos.ap-guangzhou.myqcloud.com/test-json/2.json"), this.$request("https://sgzy-1301196439.cos.ap-guangzhou.myqcloud.com/test-json/3.json") ]).then(function(e) {
        ...
        handleColumnChange: function(e) {
            var n = this.properties.type, i = this.data._range, r = e.detail, o = r.index, a = r.item;
            if (parseInt(o) < parseInt(t[n]) - 1) {
                var s = this.getDataByParentCode(a.code, o + 1);
                i[o + 1] = {
                    title: o + 1 === 1 ? "城市" : "区/县",
                    data: s
                };
