...
Component({
    ...
    methods: {
        ...
        getRegionData: function() {
            var e = this;
            return this._retry = 3, Promise.all([ this.$request("https://sgzy-1301196439.cos.ap-guangzhou.myqcloud.com/test-json/1.json"), this.$request("https://sgzy-1301196439.cos.ap-guangzhou.myqcloud.com/test-json/2.json"), this.$request("https://sgzy-1301196439.cos.ap-guangzhou.myqcloud.com/test-json/3.json") ]).then(function(t) {
