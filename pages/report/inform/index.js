...
var n, i = Object.assign || function(e) {
    ...
    return e;
}, o = getApp(), s = o.Anim, r = o.Event, c = o.config, l = o.dayjs, u = (o.userStore, 
require("../../../utils/util").chooseLocation), d = require("../../../services/report"), g = require("../../../services/region"), h = (require("../../../services/health-code.js"), 
{
    username: "",
    reportName: "",
    phone: "",
