...
var t = Object.assign || function(e) {
    ...
    return e;
}, a = getApp(), n = a.Anim, i = a.request, r = a.dayjs, o = a.utils, l = {
    0: "处理中",
    1: "进行中",
    2: "已办结"
}, s = {
...
n.Page({
    ...
    fetchData: function(e) {
        ...
        i({
            ...
            e.personTypeStr = m[e.personType], e.birthday = r(e.birthday).format("YYYY/MM/DD"), 
            e.username = e.username || "-", e.symptomTypeStr = e.symptomList && e.symptomList.map(function(e) {
                return b[e];
            ...
            e.healthState = e.healthState || "", e.healthStateStr = e.healthState && p[e.healthState], 
            e.nationStr = s[e.isChinese] || "", e.domicilePlaceStr = "1" == e.isChinese ? c[e.domicilePlace] || "" : "", 
            e.nativePlace = "3" != e.isChinese ? e.nativePlace : "", e.domicilePlaceStr = c[e.domicilePlace] || "", 
            e.residentFlagStr = u[e.residentFlag] || "", e.residentConditionStr = y[e.residentCondition] || "", 
            e.travelRegionClassStr = h[e.travelRegionClass] || "", e.recentRegionName = 4 == e.residentCondition ? e.recentRegionName : "", 
